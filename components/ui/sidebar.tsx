    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col glass-card group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:border-[rgba(216,231,242,0.1)] group-data-[variant=floating]:shadow-[0_8px_32px_rgba(0,0,0,0.3)]"
          >
            {children}
          </div>
        </div>
