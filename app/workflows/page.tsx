...
export default function WorkflowsPage() {
  ...
  const stats = [
    { label: "Active Workflows", value: "24", change: "+3", icon: <Workflow className="w-4 h-4 text-blue-400" /> },
    { label: "Total Runs", value: "12.5K", change: "+8.2%", icon: <Play className="w-4 h-4 text-green-400" /> },
    { label: "Success Rate", value: "96.8%", change: "+2.1%", icon: <CheckCircle className="w-4 h-4 text-emerald-400" /> },
    { label: "Avg Runtime", value: "2.3s", change: "-0.4s", icon: <Clock className="w-4 h-4 text-orange-400" /> }
  ];
              ...
              <div key={workflow.id} className="glass-card p-4 rounded-xl">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button className="p-1.5 hover:bg-[rgba(216,231,242,0.1)] rounded-lg transition">
                      <Edit className="w-3 h-3 text-[rgba(216,231,242,0.7)]" />
                    </button>
                  </div>
                </div>
